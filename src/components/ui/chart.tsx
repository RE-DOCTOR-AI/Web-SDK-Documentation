...
function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    const [item] = payload as CustomTooltipPayloadItem[]
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        {(payload as CustomTooltipPayloadItem[]).map((item, index) => {
...
interface CustomLegendProps {
  className?: string
  hideIcon?: boolean
  payload?: Array<{ dataKey?: string; value?: string; color?: string; payload?: any }>
